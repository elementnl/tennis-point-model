"""Compute point importance scores from trained model."""
...
def analyze_match(model: PointImportanceModel, match: dict) -> dict:
    """Analyze point importance for a single match."""
...
def aggregate_importance_by_score(
    ...
    """Compute average importance by score state. Excludes (0,0)."""
